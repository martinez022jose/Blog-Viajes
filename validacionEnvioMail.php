...
//if(isset($_POST['submit'])){
    ...
    echo "<p class='error'>*Error debe ingresar un nombre</p>";
    ...
    echo "<p class='error'>*Error debe ingresar un apellido</p>";
    ...
    if(empty($_POST['email'])){
      ...
      echo "<p class='error'>*Error debe ingresar un correo</p>";
    ...
    if(empty($_POST['mensaje'])){
       ...
       echo "<p class='error'>*Error debe ingresar un mensaje</p>";
	}
